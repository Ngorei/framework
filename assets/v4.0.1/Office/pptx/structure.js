export function menuStructure(attr) {
   ...
   let pptx = true; // Nilai default

   if (toPptx && toPptx.status === 'success') {
     pptx = null;
   }

  console.log(toSlideshow)
   const menuStructure = {
     className: 'menu',
     children: [
       {
         ...
         children: [
           {
             ...
             id: 'tabelset',
             className: 'menu-item',
             attributes: { 'data-action': 'addSlideshow' },
             children: [
               {
                 type: 'div',
                 className: 'menu-button',
                 children: [
                   { type: 'i', className: 'icon-feather-image' },
                   { type: 'span', textContent: 'Slideshow' },
                   { type: 'span', id: 'appTabel', attributes: { 'data-action': 'slideshow' }, textContent: toSlideshow.folder }
                 ]
               }
             ]
           }
             ...
             children: [
               {
                 type: 'div',
                 id: 'scissors',
                 className: 'settings-button pl-20px',
                 textContent: 'Text'
