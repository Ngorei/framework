...
// 
    ...
    // Tambahkan pemanggilan contextmenu di sini
    contextmenu({ 
        attr: attr,
        datatum:officeMenu,
        file: attr.fileName,
   ...
   function saveContent() {
    ...
    dowppt.addEventListener("click", function (e) {
    ...
    preview.addEventListener("click", function (e) {
      onRoute(["Office","Pratinjau","#explorer/presentation",attr])
