import { menuStructure, createElementFromStructure } from "./structuredocx.js";
...
// console.log(e.target.id)
  ...
  function saveItem() {
     const currentPath=STG.localStorage("breadcrumb").get();
     var folder = currentPath.join('/');
      const from = STG.BriefSnd({
        "endpoint":"E2172-A973C-CCA3F-81F00",
        "file": attr.attr.fileName,  
  ...
  function handleMenuClick(e) {
    ...
    case "animation":
          ...
          break;
    case "printer":
         onRoute(["Office","Print","#setting/print",attr.attr])
          break;
    case "addgrid":
...
break;
      ...
      break;
      case "public":
        onModal([attr.datatum.check])
        setCookie("explorer", attr.file);
      break;
      case "addTabel":
